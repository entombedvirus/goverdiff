...
func TestMessaging(t *testing.T) {
	...
	t.Run("summaryMessage()", func(t *testing.T) {
		...
		assert.Equal(t, "Coverage decreased by `1.05%`", summaryMessage(205, 100))                         // 2.05% -> 1.00%
		assert.Equal(t, "Coverage decreased by `99.00%`", summaryMessage(10000, 100))                      // 100.00% -> 1.00%
		assert.Equal(t, "Coverage decreased by `98.98%`", summaryMessage(10000, 102))                      // 100.00% -> 1.02%
